...
class TBoostrap{
	...
	public function __construct(array $config,Controller $controller,$controller_name,$action_name){
		$this->config=$config;
	...
	protected function setLayout($layout_file){
		$this->controller->setLayout($layout_file);
	}
